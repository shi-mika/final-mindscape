...
import 'mentalhealthsupp_copy_model.dart';
export 'mentalhealthsupp_copy_model.dart';

class MentalhealthsuppCopyWidget extends StatefulWidget {
  const MentalhealthsuppCopyWidget({super.key});

  @override
  _MentalhealthsuppCopyWidgetState createState() =>
      _MentalhealthsuppCopyWidgetState();
}

class _MentalhealthsuppCopyWidgetState extends State<MentalhealthsuppCopyWidget>
    with TickerProviderStateMixin {
  late MentalhealthsuppCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MentalhealthsuppCopyModel());
