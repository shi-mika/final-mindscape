...
import '/cha_client/empty_state_simple/empty_state_simple_widget.dart';
...
import 'mhpinvite_model.dart';
export 'mhpinvite_model.dart';

class MhpinviteWidget extends StatefulWidget {
  const MhpinviteWidget({
    super.key,
    this.chatRef,
  });
  ...
  @override
  _MhpinviteWidgetState createState() => _MhpinviteWidgetState();
}

class _MhpinviteWidgetState extends State<MhpinviteWidget> {
  late MhpinviteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MhpinviteModel());
          ...
          title: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Select metal health professionals from below to start a chat.',
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      } else if (_model.friendsList.length >= 3) {
